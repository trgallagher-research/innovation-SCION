...
export function appendMessage(role, text) {
  // "note" messages are display-only step dividers (e.g. "Moving to Sensemaking").
  // They are rendered as a centered separator, not a chat bubble, and never sent
  // to the model (app.js filters them out before calling a provider).
  if (role === "note") {
